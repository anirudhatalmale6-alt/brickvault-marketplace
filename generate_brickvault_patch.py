...
print("Applying patch fixes...")

write_file("src/lib/services/listings.ts", """
...
const eslintConfig = [
  ...
  { rules: { "@typescript-eslint/no-explicit-any": "off", "@typescript-eslint/no-unused-vars": ["warn", { argsIgnorePattern: "^_" }], "@next/next/no-img-element": "warn" } },
];
export default eslintConfig;
""")

write_file("public/favicon.svg", """
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <rect width="32" height="32" rx="6" fill="#E3000B"/>
  <text x="16" y="23" font-family="Arial,sans-serif" font-size="22" font-weight="bold" fill="white" text-anchor="middle">B</text>
</svg>
""")
